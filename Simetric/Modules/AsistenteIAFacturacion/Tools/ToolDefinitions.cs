    ...
    [
        ...
        Function(CrearCliente, "Crea un cliente nuevo cuando no existe y el usuario ya proporcionó todos los datos requeridos.",
            Properties(
                ...
                ("celular", "string", "Celular opcional; puede incluir código de país y separadores.", false),
                ("telefono", "string", "Teléfono opcional; puede incluir código de país y separadores.", false),
