...
USING (VALUES
    ...
    (N'e-sign',     N'E-Rúbrica',   N'E-Rúbrica para firma electronica y certificado digital de documentos en linea.', N'/e-sign',            CAST(0 AS bit), CAST(1 AS bit), 2, N'ri-key-2-line',        N'#2E7D32'),
